    ...
    <>
      ...
      >
        ...
        <figure className="my-8">
          <img src={adamHowellPassport.src} alt="Adam Howell's Canadian passport" className="rounded-lg shadow-lg max-w-md mx-auto" />
        </figure>

        <h2>The Core of His "Business Model": Pump-and-Dumps, Rug Pulls, and Inflated Fundraising</h2>
        <p>
        ...
        <h2>Exploiting Connections: Name-Dropping, Partnerships, and Rapid Burnouts</h2>
        <p>
        ...
        <ul>
          <li>
            <strong>Leveraging Reputations for Gain:</strong> Howell has a history of aligning with influencers, entrepreneurs, and even tangential celebrities to pitch his schemes. He name-drops these connections in fundraising efforts, implying endorsements that often don't exist. However, partnerships sour quickly; his volatile personality leads to blowups, with accusations of betrayal flying from all sides.
          </li>
          <li>
            <strong>Pickup Artist Business and Manipulation Tactics:</strong> In a darker chapter, Howell ran a "pickup artist" operation teaching men manipulative techniques to pursue women for sex. This venture, disguised as self-improvement, promoted unethical strategies and further tarnished his reputation, revealing a pattern of exploitation extending beyond finance. Once he failed being a pickup artist, he went to live in the sex capital of the world, to pay for sex. Where he invested in bar businesses involving ladys for hire. (he currently has a smear campaign against them also)
          </li>
          <li>
            <strong>Rebill Scams:</strong> Early schemes included rebill frauds, where users are tricked into recurring charges for low-value products or services. These deceptive practices set the stage for his later crypto cons, demonstrating a consistent disregard for ethical boundaries.
          </li>
        </ul>
        <p>
        ...
        <h2>A History of Extortion and Sabotage: Targeting Ex-Partners</h2>
        <p>
        ...
        <figure className="my-8 float-left mr-6 mb-4">
          <img src={andrewDrummondPost.src} alt="Andrew Drummond's social media post about Adam Howell" className="rounded-lg shadow-lg max-w-[282px]" />
        </figure>
        ...
        <h2 className="clear-both">Legal Troubles: Defamation Conviction and Flight to Dubai</h2>
        <p>
          Howell's antics have caught up with him legally, culminating in a flight from justice.
        </p>
        <ul>
          <li>
            <strong>Defamation Conviction:</strong> On August 28, 2025, Howell lost a criminal defamation case in Thailand, receiving a 6-month suspended sentence for false allegations against Bryan and Punnipa Flowers. He said he has appealed (but it wasn't a valid appeal), but the conviction stems from libelous YouTube videos and articles accusing others of fraud without evidence.
          </li>
          <li>
            <strong>Pending Charges and Fleeing:</strong> Facing two more criminal cases in early 2026, a cyber crime charge, and a civil defamation hearing on January 22, 2026, Howell has fled to Dubai to evade accountability. This mirrors tactics of other international fugitives, like the French rug puller extradited from Dubai for wire fraud. His alliances, including payments to smear merchants like Andrew Drummond (around 1,000 USD per article), have fueled these legal battles.
          </li>
        </ul>

        <p>A timeline of key legal and scam events:</p>

        <div className="overflow-x-auto my-8 clear-both">
          <table className="w-full text-sm">
            <thead>
              <tr>
                <th className="text-left p-3 bg-secondary font-bold">Year</th>
                <th className="text-left p-3 bg-secondary font-bold">Event</th>
                <th className="text-left p-3 bg-secondary font-bold">Outcome</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b"><td className="p-3">Pre-2021</td><td className="p-3">Rebill scams, pickup artist business</td><td className="p-3">Ethical failures, no major charges</td></tr>
              <tr className="border-b"><td className="p-3">2021</td><td className="p-3">SuperDoge rug pull (13M USD raised)</td><td className="p-3">Abandoned, investor losses</td></tr>
              <tr className="border-b"><td className="p-3">~2010s</td><td className="p-3">DopeCoin pump-and-dumps</td><td className="p-3">Market manipulation allegations</td></tr>
              <tr className="border-b"><td className="p-3">2025</td><td className="p-3">Defamation conviction in Thailand</td><td className="p-3">6-month suspended sentence</td></tr>
              <tr className="border-b"><td className="p-3">2026</td><td className="p-3">Pending criminal/cyber cases</td><td className="p-3">Fled to Dubai</td></tr>
            </tbody>
          </table>
        </div>

        <h2>Conclusion: A Stark Warning to Angel Investors and the Public</h2>
        <p>
...
export default UnmaskingAdamHowell;
