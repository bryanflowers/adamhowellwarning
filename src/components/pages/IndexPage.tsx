    ...
    "@graph": [
      {
        ...
        "publisher": { "@id": "https://adamhowellwarning.com/#organization" },
      },
      {
        "@type": "Organization",
        "@id": "https://adamhowellwarning.com/#organization",
        "name": "Adam Howell Warning",
        "url": "https://adamhowellwarning.com",
        "logo": {
          "@type": "ImageObject",
          "url": "https://adamhowellwarning.com/og-adam-howell.png",
        },
        "sameAs": [
      ...
      },
      {
        ...
        "author": { "@id": "https://adamhowellwarning.com/#organization" },
        "publisher": { "@id": "https://adamhowellwarning.com/#organization" },
        "datePublished": "2024-11-22",
        "dateModified": "2026-02-21",
        "mainEntityOfPage": "https://adamhowellwarning.com",
      },
    ],
  };
          ...
          <div ref={proseRef} className={PROSE_CLASSES}>
            ...
            <div className="md:flex md:gap-6 my-8">
              <figure className="md:w-1/3 shrink-0 mb-4 md:mb-0">
                <img src={andrewDrummondPost.src} alt="Andrew Drummond's post about Adam Howell outside court" className="rounded-lg shadow-lg w-full" />
            ...
            <div className="md:flex md:flex-row-reverse md:gap-6 my-8">
              <figure className="md:w-1/3 shrink-0 mb-4 md:mb-0">
                <img src={fakeFbMessages.src} alt="Fake Facebook messages from Adam Howell using alias Tom Davidson" className="rounded-lg shadow-lg w-full" />
            ...
            <div className="md:flex md:gap-6 my-8">
              <figure className="md:w-1/3 shrink-0 mb-4 md:mb-0">
                <img src={adamHowellPassport.src} alt="Adam Howell's Canadian passport" className="rounded-lg shadow-lg w-full" />
            ...
            <div className="md:flex md:flex-row-reverse md:gap-6 my-8">
              <figure className="md:w-1/3 shrink-0 mb-4 md:mb-0">
                <img src={adamHowellRebillChat.src} alt="Adam Howell rebill scam chat messages" className="rounded-lg shadow-lg w-full" />
      ...
      <article className="py-0">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className={PROSE_CLASSES}>
            ...
            <div className="md:flex md:gap-6 my-8">
              <figure className="md:w-1/3 shrink-0 mb-4 md:mb-0">
                <img src={adamHowellDmca.src} alt="Adam Howell's DMCA takedown request to suppress criticism" className="rounded-lg shadow-lg w-full" />
            ...
            <ul>
              <li>YouTube creators who published expos&eacute;s about his crypto projects.</li>
            ...
            <div className="md:flex md:flex-row-reverse md:gap-6 my-8">
              <figure className="md:w-1/3 shrink-0 mb-4 md:mb-0">
                <img src={drummondDopecoinComment.src} alt="Drummond commenting on DopeCoin while defending Adam Howell" className="rounded-lg shadow-lg w-full" />
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link href={localPath("/blog")} className="text-primary flex items-center gap-1 text-sm font-medium hover:underline">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {blogArticles.slice(0, 8).map((article) => (
              <Link
                key={article.slug}
                href={localPath(`/blog/${article.slug}`)}
