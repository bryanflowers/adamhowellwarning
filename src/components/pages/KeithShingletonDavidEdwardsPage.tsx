    ...
    <>
      ...
      >
        ...
        <figure className="my-8">
          <img src={davidEdwardsLinkedin.src} alt="David Edwards LinkedIn profile - Founder of EZi Gold" className="rounded-lg shadow-lg w-full max-w-[816px]" />
        </figure>
        ...
        <figure className="my-8">
          <img src={keithShingletonLinkedin.src} alt="Keith Shingleton LinkedIn profile - Digital Chipmunks" className="rounded-lg shadow-lg w-full max-w-[804px]" />
          <figcaption className="text-sm text-muted-foreground mt-2">According to Adam Howell, Keith Shingleton has a history of drug-related criminal convictions in Canada and was jailed once.</figcaption>
        </figure>

        <h3>Keith Shingleton's Legitimate Businesses</h3>
        <ol>
          <li><strong>Digital Chipmunks</strong> — Description: A digital marketing agency offering SEO, PPC, web design, and social media services. Status: Active and operational in Red Deer, Alberta. Ties to Adam Howell: None apparent; no mentions of Howell or crypto scams on the site or portfolio.</li>
          <li><strong>Hutterite Marketplace</strong> — Description: An e-commerce platform selling farm products like beef and grains from Canadian Hutterite colonies. Status: Active with secure payments. Ties to Adam Howell: None; no crypto or Howell connections.</li>
        </ol>
        <p>
        ...
        <ul>
          <li>AI-powered "Ai Ninja Toolbox" with 11 plugins (e.g., Keyword Ninja for optimization, Image Ninja for visuals, Guardian Ninja for bot protection).</li>
          <li>Automated SEO content (2,500–7,000 words), images, and social syndication to platforms like X, Facebook, LinkedIn, Instagram, Reddit.</li>
          <li>Subscriptions: Silver (£300/month, 15 spots) and Gold (£400/month, 10 spots), requiring a 2-year commitment.</li>
          <li>"Human Overview" (AI + editing) and global syndication via Epyc Servers.</li>
        </ul>
        <p><strong>Red Flags:</strong></p>
        <ul>
          <li>Urgency tactics: "Only 13 Silver spots left, prices rising soon"—creating FOMO without evidence of demand.</li>
          <li>Exaggerated claims: £29,000–£101,000 annual savings, no public case studies or ROI proof (only via founder calls).</li>
          <li>Long-term locks: 2-year commitments could trap users, similar to Howell's ICOs where funds were raised but projects vanished.</li>
          <li>Cross-promotion on abandoned crypto pages: Using DopeCoin's audience for non-crypto services smells of opportunism, akin to Howell's pivots (e.g., rebranding DopeCoin to squeeze more value).</li>
          <li>No transparency: Privacy policy is basic, but the setup mirrors Howell's undelivered tech (e.g., CryptoBillings as a "basic website" pitched for millions).</li>
        </ul>
        <p>EZi Gold isn't overtly crypto, but its hype-and-lock approach resembles Howell's scams: Promise revolution, extract commitments, deliver little. If integrated with crypto (e.g., tokenizing SEO), it could become another rug pull.</p>
        ...
        <p>Domains for Howell's projects are gone, signaling abandonment and evidence removal:</p>
        <ul>
