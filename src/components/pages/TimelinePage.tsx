      ...
      <SEOHead
        ...
        jsonLd={{
          ...
          breadcrumb: {
            "@type": "BreadcrumbList",
            itemListElement: [
              { "@type": "ListItem", position: 1, name: lang === "th" ? "หน้าแรก" : "Home", item: `https://adamhowellwarning.com/${lang}` },
              { "@type": "ListItem", position: 2, name: lang === "th" ? "ไทม์ไลน์" : "Timeline", item: `https://adamhowellwarning.com/${lang}/timeline` },
            ],
          },
        }}
      />
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="mt-12 bg-primary/5 border border-primary/20 rounded-xl p-6 text-center">
            ...
            <Link href={localPath("/articles")} className="text-primary font-medium hover:underline">
