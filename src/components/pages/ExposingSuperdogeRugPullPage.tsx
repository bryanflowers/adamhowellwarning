    ...
    <>
      <SEOHead
        ...
        jsonLd={{
          ...
          "mainEntityOfPage": "https://adamhowellwarning.com/exposing-the-superdoge-rug-pull-adam-howells-latest-crypto-scheme-and-the-millions-potentially-siphoned",
        }}
      />
      <ArticlePage
        title="Exposing the SuperDoge Rug Pull – Adam Howell's $13M Crypto Scheme"
      ...
      >
        <figure className="my-8">
          <img src={drummondSuperdogeDefense.src} alt="Andrew Drummond defending Adam Howell's SuperDoge launch" className="rounded-lg shadow-lg max-w-[450px] w-full" />
        ...
        <figure className="my-8">
          <img src={superDogeEdgeNft.src} alt="SuperDoge Edge of NFT podcast screenshot showing anonymous founder" className="rounded-lg shadow-lg max-w-[400px] w-full" />
        ...
        <figure className="my-8">
          <img src={adamHowellCourt.src} alt="Adam Howell outside court in Pattaya, Thailand" className="rounded-lg shadow-lg max-w-[500px] w-full" />
        ...
        <figure className="my-8">
          <img src={keithShingletonCoo.src} alt="Keith Shingleton LinkedIn profile showing COO of SuperDoge" className="rounded-lg shadow-lg max-w-[400px] w-full" />
        ...
        <figure className="my-8">
          <img src={superDogeCharities.src} alt="SuperDoge charities claim" className="rounded-lg shadow-lg max-w-[600px] w-full" />
