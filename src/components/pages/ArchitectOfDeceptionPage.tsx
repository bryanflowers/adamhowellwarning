    ...
    <>
      ...
      >
        <figure className="my-8">
          <img src={adamHowellAiPhoto.src} alt="Adams AI photo" className="rounded-lg shadow-lg max-w-[298px]" />
          <figcaption className="text-sm text-muted-foreground mt-2">Adams AI photo</figcaption>
        </figure>

        <h2>A Pattern of Predation</h2>
        <p>
        ...
        <figure className="my-8">
          <img src={adamHowellRebillChat.src} alt="Adam Howell rebill scam chat messages" className="rounded-lg shadow-lg max-w-[600px] w-full" />
          <figcaption className="text-sm text-muted-foreground mt-2">Adam was ashamed of his rebill scams, but not his dopecoin, which left lots of bag holders. However, after the dope coin pump and dumps, he went onto NFT scams.</figcaption>
        </figure>
        ...
        <figure className="my-8">
          <img src={kanokrat.src} alt="Kanokrat" className="rounded-lg shadow-lg max-w-[300px]" />
          <figcaption className="text-sm text-muted-foreground mt-2">Kanokrat was banned from the UK for cheating on her husband, who died from the stress shortly after. She works for Andrew Drummond, trying to create his victims' legal problems.</figcaption>
        </figure>
        ...
        <h3>Read more about Kanokrat below</h3>
        <p>
