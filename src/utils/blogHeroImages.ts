// Eager glob import of all blog hero images
const imageModules = import.meta.glob('/src/assets/blog/hero-*.jpg', { eager: true, import: 'default' }) as Record<string, string>;
