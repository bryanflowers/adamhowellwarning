  ...
  return (
    <Layout>
      <ArticlePage
        ...
        subtitle="Key enablers like Andrew Drummond and Kanokrat form the backbone of his extortion tactics, turning personal grudges into profitable smear operations."
        readTime="12 min read"
      >
        <p><strong>A Pattern of Predation</strong></p>
        <p>
        ...
        <h2>The Thailand Chapter: Bars, Betrayals, and Extortion</h2>
        <p>
          Howell's descent into Pattaya's nightlife scene exemplifies his opportunistic style. Arriving amid personal turmoil—with addictions and family estrangements—he invested in bars, only to turn on his partners. In one case, he demanded 55 million baht (escalating to 110 million, then 150 million) in extortion, using threats of media exposure via Andrew Drummond. When refused, the smears escalated.
        </p>
        <p>
        ...
        <h2>The Smear Machine: Andrew Drummond's Role</h2>
        <p>
          No Howell operation is complete without media manipulation, and Andrew Drummond is his go-to amplifier. Paid by Howell, Drummond churns out biased articles accusing targets of heinous crimes—trafficking, fraud, mafia ties—without evidence. In the Flowers dispute, Drummond produced over 16 pieces, attacking not just businesses but families, including doxing wives and children. Described as a 75-year-old with a history of running from criminal charges in Thailand, he edits content to suit payers, ignores contradictions, and poses as a whistleblower while enabling extortion.
        </p>
        <p>
          This triad—Howell as schemer, Kanokrat as enforcer, Drummond as propagandist—creates a vicious cycle. A business partner demands accountability; Kanokrat assists in threats or fabrications; Drummond publishes smears across platforms (YouTube, Reddit, Quora, Odysee and his sites), laundering disinformation to force settlements. Evidence from UK solicitors and Thai courts debunks these claims as baseless, relying on hearsay and coercion, yet the online damage persists.
        </p>

        <h2>Broader Implications: Harassment and Unchecked Harm</h2>
        <p>
        ...
        <p>
          Associates like Drummond and Kanokrat enable this by providing credibility and reach. Kanokrat's role, though less documented, fits the pattern of local collaborators exploiting Thailand's expat underbelly.
        </p>

        <h2>A Call for Vigilance</h2>
        <p>
          Adam Howell's story is a cautionary tale for investors, partners, and the crypto community. His schemes have left trails of losses, from SuperDoge's evaporated millions to unpaid debts in Thailand. Enablers like Drummond and Kanokrat amplify the harm, turning extortion into a business model. To counter this, demand transparency: audit projects, document interactions, and report harassment. Until Howell deletes his defamatory content and apologizes, sites like this serve as vital countermeasures. In an era of digital deception, awareness is the best defense against predators like him.
        </p>

        <blockquote>
          <p>
            <strong>Read more about Kanokrat:</strong>{" "}
            <a href="https://andrewdrummondfacts.com/kanokrat-nimsamut-booth-the-woman-behind-andrew-drummonds-troublemaking-aiding-scammer-adam-howell-in-defamation-and-human-trafficking-interference/" target="_blank" rel="noopener noreferrer">
              Kanokrat Nimsamut Booth: The Woman Behind Andrew Drummond's Troublemaking
            </a>
          </p>
        </blockquote>
...
export default ArchitectOfDeception;
