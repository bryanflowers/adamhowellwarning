  ...
  return (
    <Layout>
      ...
      >
        ...
        <figure className="my-8">
          <img src={adamHowellRebillChat} alt="Adam Howell rebill scam chat messages" className="rounded-lg shadow-lg max-w-[600px] w-full" />
        ...
        <figure className="my-8">
          <img src={kanokrat} alt="Kanokrat" className="rounded-lg shadow-lg max-w-[300px]" />
