    ...
    <Layout>
      ...
      >
        ...
        <figure className="my-8">
          <img src={adamHowellPassport} alt="Adam Howell's Canadian passport" className="rounded-lg shadow-lg max-w-md mx-auto" />
        </figure>
        ...
        <figure className="my-8 float-left mr-6 mb-4">
          <img src={andrewDrummondPost} alt="Andrew Drummond's social media post about Adam Howell" className="rounded-lg shadow-lg max-w-[282px]" />
        </figure>
