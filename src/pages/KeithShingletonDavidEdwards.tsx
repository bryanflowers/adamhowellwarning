    ...
    <Layout>
      ...
      >
        ...
        <figure className="my-8">
          <img src={davidEdwardsLinkedin} alt="David Edwards LinkedIn profile - Founder of EZi Gold" className="rounded-lg shadow-lg w-full max-w-[816px]" />
        </figure>
        ...
        <figure className="my-8">
          <img src={keithShingletonLinkedin} alt="Keith Shingleton LinkedIn profile - Digital Chipmunks" className="rounded-lg shadow-lg w-full max-w-[804px]" />
